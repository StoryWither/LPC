...
int main() {
    ...
    const double dollar_to_euro = 0.94744195; // Inserito manualmente per perdere meno precisione
    const double dollar_to_bit = 3.52423e-5; // Inserito manualmente per perdere meno precisione
